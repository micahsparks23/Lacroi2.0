$(document).ready(function() {  
    ...
    chrome.storage.local.get({
        ...
        $.ajax({
            url: `https://app.lacroi.co/api/v1/jobresult?job_id=${params.id}`,
            type: 'GET',
            headers: {
            ...
            success: function(result, textStatus, xhr) {                 
                ...
                $.each(result.data.products, function(i, value) {                                 
                    ...
                    $('#jobProds > tbody').append(`
                    <tr class="activeProds" data-toggle="modal" data-target="#myModal" data-id="${value.toplist_id}">
    ...
    $(document).on("click", ".activeProds", function(){
        ...
        $.ajax({
            url: ` https://app.lacroi.co/api/v1/jobrproductdetail?job_id=${params.id}&toplist_id=${topListId}`,
            type: 'GET',
            headers: {
                'Authorization': 'Bearer ' + api_token,             
            },         
